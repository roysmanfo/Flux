    ...
    def run(self):
        ...
        match self.args.mode:
            case "simple":
                ...
                self.print()
                self.print(format.create_table("ID", "OWNER", "NAME", "TIME ALIVE", contents=contents), end="")
            ...
            case "threads":
                ...
                self.stdout.write(format.create_table("ID", "NAME", "NATIVE ID", contents=contents))
